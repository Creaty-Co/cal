...
export const LOGO = "/platform/calcom-logo-white-word.svg";
export const LOGO_ICON = "/platform/cal-com-icon-white.svg";
export const AVATAR_FALLBACK = "/platform/avatar.svg";
export const FAVICON_16 = "/platform/favicon-16x16.png";
export const FAVICON_32 = "/platform/favicon-32x32.png";
export const APPLE_TOUCH_ICON = "/platform/apple-touch-icon.png";
export const MSTILE_ICON = "/platform/mstile-150x150.png";
export const ANDROID_CHROME_ICON_192 = "/platform/android-chrome-192x192.png";
export const ANDROID_CHROME_ICON_256 = "/platform/android-chrome-256x256.png";
